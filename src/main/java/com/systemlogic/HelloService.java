 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://webservice.com/", wsdlLocation = "http://localhost:8090/wsimportWS/Hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://webservice.com/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8090/wsimportWS/Hello?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://webservice.com/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.com/", "HelloPort"), Hello.class, features);
    }
